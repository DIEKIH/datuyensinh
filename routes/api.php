...
Route::prefix('n8n')->middleware(['throttle:15,1', VerifyN8nWebhook::class])->group(function () {
    ...
    Route::post('/toxic-comments', [AdmissionWebhookController::class, 'reportToxicComment']);
    Route::post('/social-posts', [AdmissionWebhookController::class, 'storeSocialPost']);
...
Route::prefix('admission/scoring')->group(function () {
    Route::get('/dynamic-fields', [AdmissionScoringController::class, 'publicDynamicFields']);
