...
@section('title', $post->tieude . ' — CTUT | Tuyển sinh')
...
{{-- @php
    ...
    // Bọc video thường vào container đẹp
...
@php
    ...
    $content = preg_replace_callback(
        ...
        function($matches) {
            ...
            return '<div class="video-container"><video' . $attrs . '>' . $matches[2] . '</video></div>';
        },
        $content
    );
@endphp
