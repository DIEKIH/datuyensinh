@extends('admins.pages.advise.layout')

@section('advise_title', 'OpenAI và kho tri thức RAG')
@section('advise_description', 'Quản lý instructions và các tài liệu đang được gắn với Vector Store của hệ thống tư vấn.')

@section('advise_actions')
